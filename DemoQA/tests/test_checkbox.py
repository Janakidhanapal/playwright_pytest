...
def test_checkbox_page(page: Page):
    data = load_test_data()
    Home.click_card(page, data['check_box']['card_name'])
    General.verify_elements_page_loaded(page)
    ...
    CheckBox.select_checkbox(page, data['check_box']['checkbox_name'])
    CheckBox.verify_checkbox_selected(page, data['check_box']['checkbox_name'])
